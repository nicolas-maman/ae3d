...
def main():
    ...
    (NATIVE / "ae3d_vk_uniforms.h").write_text(
        c_struct(placed, size, light_placed, light_stride))

    module = ROOT / "src/ae3d/vkscene"
    module.mkdir(parents=True, exist_ok=True)
    (module / "module.ae").write_text(
        aether_offsets(placed, size, light_placed, light_stride))
