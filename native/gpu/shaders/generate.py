...
def c_struct(placed, size, light_placed=None, light_stride=0):
    lines = [
        "/* Generated by native/gpu/shaders/generate.py - do not edit. */",
...
def main():
    ...
    outputs[GPU / "vulkan_uniforms.h"] = c_struct(placed, size, light_placed, light_stride)
    ...
    if "--check" in sys.argv[1:]:
        ...
        if stale:
            ...
            raise SystemExit("generate: run native/gpu/shaders/generate.py and commit the result")
    ...
    checked = 0
    header = ["/* Generated by native/gpu/shaders/generate.py - do not edit. */",
